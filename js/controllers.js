	...
	$.ajax({
	    	...
	    	success: function (data) {			    	
		    	...
		    	if(tomorrowData == null){
			    	...
			    	html+= "<td><table class='table table-hover'><tr><td><img src='../images/surficon.png' class='iconimg'/><h3>"+tomorrowData.swell_height_metres+"mts "+tomorrowData.swell_direction_compass_point+"</h3> "+tomorrowData.swell_direction_degrees+"&deg; @ " +tomorrowData.swell_period_seconds+"s</td></tr><tr><td><img src='../images/windicon.png' class='iconimg'/><h3>"+tomorrowData.wind_speed_knots+"kn "+tomorrowData.wind_direction_compass_point+"</h3> "+tomorrowData.wind_direction_degrees+"&deg;</td></tr></table></td>";
		    	}
		    	...
		    	if(dayAfterData == null){
		    		...
		    		html+= "<td><table class='table table-hover'><tr><td><img src='../images/surficon.png' class='iconimg'/><h3>"+dayAfterData.swell_height_metres+"mts "+dayAfterData.swell_direction_compass_point+"</h3> "+dayAfterData.swell_direction_degrees+"&deg; @ " +dayAfterData.swell_period_seconds+"s</td></tr><tr><td><img src='../images/windicon.png' class='iconimg'/><h3>"+dayAfterData.wind_speed_knots+"kn "+dayAfterData.wind_direction_compass_point+"</h3> "+dayAfterData.wind_direction_degrees+"&deg;</td></tr></table></td>";
		    	}
